...
public class UsedLanguageCounter {
    ...
    public Topology createTopology() {
        ...
        commits_stream.mapValues(v -> v.get("repository").get("language").toString())
                ...
                .mapValues((k, v) -> k + ": " + v)
                .toStream()
                .to("out-languages-count", Produced.with(Serdes.String(), Serdes.String()));
    ...
    public static void main(String[] args) {
        ...
        config.put(StreamsConfig.APPLICATION_ID_CONFIG, "metrics-used-language-counter");
        ...
        UsedLanguageCounter app = new UsedLanguageCounter();
